...
ExpansionChunk::ExpansionChunk(std::shared_ptr<ExpansionHistory> & historyHandler) :
    _historyHandler(historyHandler),
    _bundleHandler(std::make_unique<SfmBundle>())
{
...
{
    SfmTriangulation triangulation(_triangulationMinPoints);
